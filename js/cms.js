...
var CMS = function (o) {
    ...
    var i = {
        ...
        }, r = 'ERROR: No element ID or ID incorrect. Check "elementId" parameter in config.',
        s = "ERROR: Error getting files. Make sure there is a directory for each type in config with files in it.",
        l = "ERROR: Error getting the file",
        a = "ERROR: Error loading layout. Check the layout file to make sure it exists.",
    ...
    function u() {
        this.rules = [{
            ...
            regex: /&&&[a-z]*\n[\s\S]*?\n&&&/g, replacement: function (t) {
                return '<script type="text/javascript">' + (t = t.replace(/```/gm, "")).trim() + "<\/script>"
            }
        }, {regex: /`(.*?)`/g, replacement: "<code>$1</code>"}, {
            regex: /\n\*(.*)/g, replacement: function (t, e) {
                return "\n<ul>\n\t<li>" + e.trim() + "</li>\n</ul>"
            }
        }, {
            regex: /\n[0-9]+\.(.*)/g, replacement: function (t, e) {
                return "\n<ol>\n\t<li>" + e.trim() + "</li>\n</ol>"
            }
        }, {
            regex: /\n(&gt;|>)(.*)/g, replacement: function (t, e, n) {
    ...
    function g(t, i, r) {
        h(t, function (t, e) {
            var n;
            e && r(t, e), r((n = t, new Function("data", "var output=" + JSON.stringify(n).replace(/<%=(.+?)%>/g, '"+($1)+"').replace(/<%(.+?)%>/g, '";$1\noutput+="') + ";return output;")(i)), e)
        })
    }

    function d(t, e) {
        n.innerHTML = "", g([o.layoutDirectory, "/", t, ".html"].join(""), e, function (t, e) {
            e ? m(a) : n.innerHTML = t
        })
    }
    ...
    y.prototype = {
        init: function (n) {
            this.getFiles(function (t, e) {
                e && m(s), this.loadFiles(function (t, e) {
                    e && m(l), n()
                }.bind(this))
            }.bind(this))
            ...
            var e;
            if ("GITHUB" === o.mode) e = JSON.parse(t); else {
            ...
            var s = [];
            this.files.forEach(function (n, i) {
                n.getContent(function (t, e) {
                    e && r(t, e), s.push(i), n.parseContent(), this.files.length == s.length && r(t, e)
                }.bind(this))
            }.bind(this))
        }, search: function (e, n) {
            ...
            this[this.type] = this.files.filter(function (t) {
                if (e && t.tags) return t.tags.some(function (t) {
                    return t === e
                })
            })
    ...
    var b = function (t, e, n) {
        this.url = t, this.type = e, this.layout = n, this.html = !1, this.content, this.name, this.extension, this.title, this.excerpt, this.date, this.datetime, this.author, this.body, this.permalink, this.tags
    };
    b.prototype = {
        getContent: function (n) {
            h(this.url, function (t, e) {
                e && n(t, e), this.content = t, "string" == typeof this.content && n(t, e)
            }.bind(this))
            ...
            if (t) {
                ...
                t.split(/\n/g).forEach(function (t) {
                    ...
                    var i;
                    for (i in void 0 === e && (e = t), e) Object.prototype.hasOwnProperty.call(e, i) && (t[i] = e[i]);
                    n && n()
                }(this, n, null)
            }
        }, setListAttributes: function () {
            o.listAttributes.forEach(function (t) {
                this.hasOwnProperty(t) && this[t] && (this[t] = this[t].split(",").map(function (t) {
                    return t.trim()
                }))
            }.bind(this))
        }, setFilename: function () {
            this.name = this.url.substr(this.url.lastIndexOf("/")).replace("/", "").replace(o.extension, "")
        }, setPermalink: function () {
            this.permalink = ["#", this.type, this.name].join("/")
        }, setDate: function () {
            var t = new RegExp(o.dateParser);
            this.date ? (this.datetime = new Date(this.date), this.date = p(this.date)) : t.test(this.url) && (this.date = t.exec(this.url), this.datetime = new Date(this.date), this.date = p(this.date))
        }, setBody: function () {
            var t = this.content.split(o.frontMatterSeperator).splice(2).join(o.frontMatterSeperator);
            if (this.html) this.body = t; else if (o.markdownEngine) this.body = o.markdownEngine(t); else {
                var e = new u;
        ...
        this.ready ? (this.collections[t].search(e, n), this.collections[t].render()) : m(c)
    }, this.route = function () {
        var t = window.location.hash.split("/").map(function (t) {
            return 0 <= t.indexOf("?") && (t = t.substring(0, t.indexOf("?"))), t
        }).filter(function (t) {
            return "#" !== t
        }), e = t[0], n = t[1], i = this.collections[e], r = f("query") || "", s = f("tag") || "";
        ...
        o.plugins.forEach(function (t) {
            var e, n = e = (e = (e = t.toString()).substr("function ".length)).substr(0, e.indexOf("("));
            this[n] || (this[n] = t)
        }.bind(this))
        ...
        var t;
        (o = Object.assign({}, i, o)).debug && (t = o.messageClassName, (e = document.createElement("div")).className = t, e.innerHTML = "DEBUG", e.style.background = "yellow", e.style.position = "absolute", e.style.top = "0px", document.body.appendChild(e)), window.addEventListener("hashchange", this.route.bind(this)), o.elementId && (n = document.getElementById(o.elementId)) ? this.initFileCollections(function () {
            window.dispatchEvent(new HashChangeEvent("hashchange")), this.ready = !0, this.registerPlugins(), o.onload()
        }.bind(this)) : m(r)
    }, this.init()
};
